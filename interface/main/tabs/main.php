...
<body class="min-vw-100">
    ...
    <div id="mainBox" <?php echo $disp_mainBox; ?> >
        <nav class="navbar navbar-expand-xl navbar-light bg-light py-0 px-0 px-xl-1 oemr-navbar">
            <a class="navbar-brand mt-2 mr-3 mx-xl-2 mt-xl-0" href="https://www.open-emr.org" title="OpenEMR <?php echo xla("Website"); ?>" rel="noopener" target="_blank">
